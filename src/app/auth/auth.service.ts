...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-466826:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-466826:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oa22flm26C6Vm3Eu357';
    const issuer = 'https://dev-466826.okta.com/oauth2/default';
